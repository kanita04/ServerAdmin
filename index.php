...
<body>
    <div>
    <header
  class="ezy__header42 light py-14 md:py-24 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-10"
>
  <!-- shape one -->
  <svg
  ...
  <!-- bg shape -->
  <div
    class="absolute -top-[15%] -right-[15%] w-[600px] h-[600px] rounded-full bg-slate-100 dark:bg-slate-800 -z-20"
  ></div>
  ...
  <div class="container px-4 mx-auto">
    <div class="grid grid-cols-12 gap-6 items-center">
      ...
      >
        ...
        <button
          class="py-2 px-8 font-medium text-white bg-blue-600 hover:bg-opacity-90"
        >
          Login
        </button>
        </a>
      ...
      <div class="col-span-12 lg:col-span-5 relative text-center">
        <!-- shape seven -->
        <svg
          class="absolute top-0 left-0 lg:-left-[150px] -z-30"
          width="291"
          height="168"
          viewBox="0 0 291 168"
          fill="none"
        ...
        <div class="relative">
          ...
          />
          <div
            class="absolute w-[500px] h-[500px] left-0 top-0 bg-slate-100 dark:bg-slate-800 rounded-full -z-20"
          ></div>
        </div>
      </div>
    </div>
